...
cd "$(dirname "$0")/.."
run_dir="experiment_runs/p2_sft_30k"
...
NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 CUDA_VISIBLE_DEVICES=0,1,2,3 \
  ...
  --data_path dataset/sft_i2t_30k.parquet \
  ...
  --log_interval 20 \
  --save_interval 500 \
  --save_weight sft_vlm_30k \
  --save_dir out \
  --checkpoint_dir checkpoints \
  2>&1 | tee "$run_dir/train.log"

sha256sum out/sft_vlm_30k_768.pth checkpoints/sft_vlm_30k_768_resume.pth > "$run_dir/SHA256SUMS"
